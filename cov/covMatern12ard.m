function Kxx = covMatern12ard(hypCov, x1, x2)
% covMatern12ard: Calculates the Matern covariance matrix with automatic
...
for i = 1:n1(1)
    for j = 1:n2(1)
        Kxx(i,j) = elementMatern12ard(x1(i,:), x2(j,:), l, sigma);
    end
end
end